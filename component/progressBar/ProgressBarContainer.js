  ...
  return (
    ...
    <div className={classes.first}>
      ...
      <div className={classes.second}>
          <ProgressBar isIntersecting={isIntersecting} desc={'Pedal Assist Motor'} timeToStop={45}/>
          <ProgressBar isIntersecting={isIntersecting} desc={'250 Watts Motor'} timeToStop={25}/>
